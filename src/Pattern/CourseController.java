...
public class CourseController extends JPanel implements Observer, ChangeListener, ActionListener {
	 ...
	 */
	 public void update(Observable o, Object newData) {
                ArrayList<Object> nData = (ArrayList<Object>)newData;
	
		for (int i = sliders.size(); i < nData.size(); i++) {
			this.addCourse((CourseRecord) nData.get(i));
		}
	} 
