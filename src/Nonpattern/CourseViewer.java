...
public class CourseViewer extends JFrame implements ActionListener,
	 ...
	 */
        ArrayList<Integer> sliderData;
	public CourseViewer() {
                sliderData = new ArrayList<Integer>();
	...
	public void paintBar(Graphics g) {
		...
		for (int i = 0; i < sliders.size(); i++) {
			JSlider record = sliders.get(i);
                        this.sliderData.add((int)record.getValue());
            ...
            System.out.println(this.sliderData);
	}
        ...
        public void paint(Graphics g){
            ...
            for (int i = 0 ; i< sliders.size(); i++){
                this.sliderData.add(sliders.get(i).getValue());
            }
            this.paintPie(g, this.sliderData);
            
            this.sliderData.clear();
        }
     
        public void paintPie(Graphics g, ArrayList<Integer> data) {
                super.paint(g);
                int radius = 100;
